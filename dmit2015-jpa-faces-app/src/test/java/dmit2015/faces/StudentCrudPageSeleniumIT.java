...
//        driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(5));
    ...
    @ParameterizedTest
    @CsvSource(value = {
            "firstName, Bruce, lastName, Less, courseSection, DMIT2015-A02,",
            "firstName, Justin, lastName, Russell, courseSection, DMIT2015-A02,",
            "firstName, Aaron, lastName, Vaartstra, courseSection, DMIT2015-A02,",
    })
    void shouldCreate(
    ...
    @ParameterizedTest
    @CsvSource({
            "0, Bruce, Less, DMIT2015-A02",
            "1, Justin, Russell, DMIT2015-A02",
            "2, Aaron, Vaartstra, DMIT2015-A02",
    })
    void shouldList(
            int idIndex,
