...
public class StudentCrudView implements Serializable {
    ...
    public void onGenerateData() {
        try {
            ...
            selectedStudent.setCourseSection("DMIT2015-A02");
    ...
    public void onSave() {
        try {
            ...
            if (imageFileUpload != null) {
                ...
                String base64EncodedImageString = Base64.getEncoder().encodeToString(imageFileUpload.getContent());
                String imageDataUrl = String.format("data:%s;base64,%s",
                        imageFileUpload.getContentType(),
